...
import destinations from "../../../Components/Tour/destinationContent";
import BreadCumb from "../../../Components/Common/BreadCumb";

interface PageProps {
  params: {
    "new-year-details": string;
  };
}
...
function NewYearDetails({ params }: any) {
  ...
  const destination = destinations.NG.find(
    (item) =>
      item.tag.toLowerCase().replace(/\s+/g, "-") === params["new-year-details"]
  );
  ...
  return (
    <>
      <BreadCumb
        bgimg={destination.bigImg || ""}
        Title={destination ? destination.name : "Destination Details"}
      ></BreadCumb>
            ...
            <div className="row g-4 justify-content-center">
              <div className="col-12 col-lg-8">
                ...
                <div className="activities-details-content">
                  <h2 className="mb-3">{destination.slogan}</h2>
                  <p className="whitespace-pre-line">{destination.about}</p>
